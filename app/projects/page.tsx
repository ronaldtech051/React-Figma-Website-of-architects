          ...
          {paginatedProjects.map((item, index) => {
            return (
              <div key={index} className="flex flex-col md:flex-row">
                <div className="relative h-[218px] md:h-[320px] md:w-1/2 lg:h-[360px] lg:w-[670px] xl:h-[435px] ">
                  <Image
                    src={item.imageUrl}
                    alt={item.title}
                    fill
                ...
                <div className="flex flex-col gap-4 bg-woa-white-100 p-4 md:w-1/2 md:p-[30px] xl:gap-[64px] ">
                  <h2 className="truncate text-[40px] font-light leading-none text-woa-white-400 xl:leading-normal">
                    {item.title}
                  </h2>
